...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://artem-stackbit.ngrok.io/pull/6059e7dbc252138d41fef465
...
To start editing your site, you can use the Sanity interface at https://violet-squid-9e7db.sanity.studio/.
...
Generated at `2021-03-23T13:06:57.935Z` by Stackbit version `0.3.50-staging.0`.